          ...
          <ContentWrapper className=" mt-0">
            ...
            <ContentContainer>
              <p>
                ...
                لوحدات ضمان الجودة بالمعهد وفقاً لمعايير الهيئة القومية لضمان
                جودة التعليم والإعتماد ، وبما يحقق مستوى عالى من رضاء محتلف
                الأطراف ذات الصلة.
              </p>
            </ContentContainer>
          </ContentWrapper>
          ...
          <ContentWrapper className=" sm:mt-6">
            ...
            <ContentContainer>
              <ul className=" list-disc pr-4">
                ...
                <li>
                  تطبيق نظم ضمان الجودة والانشطة الاكاديمية والبحثية والخدمية
                  وفق معايير الاعتماد.
                </li>
                <li>
