        ...
        <ContentWrapper>
          ...
          <ContentContainer>
            <ul className=" list-disc pr-4">
              ...
              <li>
                وضع الخطط والبرامج التنفيذية لشئون التسجيل والدراسة والامتحانات
                والخريجين ومتابعة تنفيذها.
              </li>
              <li>
              ...
              <li>
                إعداد كافة المعلومات والبيانات الإحصائية الخاصة بالطلاب وإبلاغها
                لشئون التعليم بالمعهد.
              </li>
              <li>
                تدبير الامكانات البشرية (ملاحظين ومراقبين) لامتحانات المعهد.
              </li>
              <li>تنمية علاقات طيبة مع ادارات شئون الطلاب بالمعاهد الأخرى.</li>
              <li>
                القيام بما يسند إليه من أعمال مع رفع تقارير عن سير العمل لوكيل
                المعهد لشئون الطلاب.
              </li>
              <li>
                إستقبال الطلاب الجدد بالفرقة الاولى واستكمال أوراقهم بعد موافقة
                مكتب التنسيق وقبول ترشيح الطلاب المحولين .
              </li>
            </ul>
          </ContentContainer>
        </ContentWrapper>
